...
const EditorBootstrap = lazy(() =>
  import('@/components/editor/EditorBootstrap').then((module) => ({
    default: module.EditorBootstrap,
  })),
)

const EmptyEditor = lazy(() =>
  import('@/components/editor/EmptyEditor').then((module) => ({
    default: module.EmptyEditor,
  })),
)
